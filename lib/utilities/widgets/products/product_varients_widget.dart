...
class ProductVarientWidget extends StatefulWidget {
  const ProductVarientWidget(
      {super.key, required this.productModel, required this.onUpdated});
...
class _ProductVarientWidgetState extends State<ProductVarientWidget> {
  double quantity = 1;
  late String? selectedSku =
      widget.productModel.items![0].variants?[0].product?.sku;
      ...
      children: [
        if (widget.productModel.items![0].configurableOptions != null)
          ListView.separated(
            ...
            itemCount:
                widget.productModel.items![0].configurableOptions!.length,
            separatorBuilder: (context, index) => const SizedBox(height: 20),
            itemBuilder: (context, index) => widget.productModel.items![0]
                        .configurableOptions![index].attributeCode ==
                    'color'
                ? buildColor(index)
                : buildVarient(
                    widget.productModel.items![0].configurableOptions![index]
                        .label!,
                    index),
            // : SizedBox(),
          ),
        ...
        children: <Widget>[
          ...
          Expanded(
            child: ListView.separated(
              ...
              itemCount: widget.productModel.items![0].configurableOptions![i]
                  .values!.length,
              ...
              itemBuilder: (context, index) => InkWell(
                ...
                onTap: () {
                  ...
                  print(widget.productModel.items![0].configurableOptions![i]
                      .values![index].swatchData);
                  setState(() => varientData[i] = widget.productModel.items![0]
                      .configurableOptions![i].values![index].uid!);
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: varientData.contains(widget.productModel.items![0]
                              .configurableOptions![i].values![index].uid)
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundColor: Color(
                      int.parse(
                          'ff${widget.productModel.items![0].configurableOptions![i].values![index].swatchData!.replaceAll('#', '')}',
                          radix: 16),
                    ),
                  ),
                ),
      ...
      child: Row(children: <Widget>[
        ...
        Expanded(
          child: ListView.separated(
            ...
            itemCount: widget
                .productModel.items![0].configurableOptions![i].values!.length,
            ...
            itemBuilder: (context, index) => InkWell(
              ...
              child: Container(
                  ...
                  child:
                      ...
                      // ?
                      Text(
                    widget.productModel.items![0].configurableOptions![i]
                        .values![index].label!,
                    style: AppStyles.getRegularTextStyle(
                      fontSize: 13,
                      color:
  ...
  late List<String> varientData = List.generate(
      widget.productModel.items![0].configurableOptions!.length,
      (index) => widget
          .productModel.items![0].configurableOptions![index].values![0].uid!);
  ...
  setSku() {
    ...
    for (var element in widget.productModel.items![0].variants!) {
      ...
      List<Map<String, dynamic>>? mediaGallery =
          element.product!.mediaGallery != null &&
                  element.product!.mediaGallery!.isNotEmpty
              ? List<Map<String, dynamic>>.from(element.product!.mediaGallery!)
              : null;
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: SizedBox(
                    width: 50,
                    height: 40,
                    child: Center(child: Icon(Icons.add, size: 17.5)),
                  ),
                )
              ],
            ),
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: InkWell(
                  ...
                  child: Text(
                    'Check',
                    style: AppStyles.getRegularTextStyle(
                        fontSize: 11, color: AppColors.fadedText),
                  ),
                ),
              ),
            ),
