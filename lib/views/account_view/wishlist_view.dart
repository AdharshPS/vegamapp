              ...
              builder: (result, {fetchMore, refetch}) {
                ...
                return GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      mainAxisSpacing: 10,
                      crossAxisSpacing: 10),
                  itemBuilder: (context, index) => BuildWishGridItem(
                    wishlistId: authToken.user.wishlists![0].id!,
...
//                   style:
//                       AppStyles.getMediumTextStyle(fontSize: 16))),
//           const SizedBox(width: 5),
//           Mutation(
//               options: MutationOptions(
//                 document:
//                     gql(ProductApi.removeProductsFromWishlist),
//                 onCompleted: (result) {
//                   //print(result);
...
//                           context: context,
//                           message:
//                               result['removeProductsFromWishlist']
...
//                     runMutation({
//                       'wishlistId':
//                           widget.authToken.user.wishlists![0].id,
...
//               text: TextSpan(
//                 children: [
//                   if (widget.data['product']['special_price'] !=
//                       null)
//                     TextSpan(
//                       text:
...
class BuildWishGridItem extends StatefulWidget {
  const BuildWishGridItem(
      {super.key,
      required this.data,
      this.refetch,
      required this.wishlistId,
  ...
  final AuthToken authToken;
  @override
  State<BuildWishGridItem> createState() => _BuildWishGridItemState();
}

class _BuildWishGridItemState extends State<BuildWishGridItem> {
  late List<String?> varientData = List.generate(
      widget.data['product']['configurable_options'].length, (index) => null);
  late String selectedSku = widget.data['product']['sku'];
                          ...
                          child: Text.rich(
                            TextSpan(
                              children: [
                                TextSpan(
                                  text:
                                      '${widget.data['product']['price_range']['maximum_price']['discount']['percent_off']}%\n off',
                                  style: AppStyles.getRegularTextStyle(
              ...
              child: Column(
                ...
                children: [
                                  ...
                                  child: ButtonTheme(
                                    ...
                                    child: DropdownButtonFormField<String>(
                                      ...
                                      items: List.generate(
                                        data['values'].length,
                                        (configIndex) => DropdownMenuItem(
                                          value: data['values'][configIndex]
                                              ['uid'],
                                          child: Text(
                                              data['values'][configIndex]
                                                  ['label'],
                                              style:
                  ...
                  Center(
                    child: Mutation(
                        options: MutationOptions(
                          document: gql(widget.data['product']['__typename'] ==
                                  'SimpleProduct'
                              ? ProductApi.addWishlistItemstoCart
                              : ProductApi.addProductToCart),
                          onCompleted: (result) {
